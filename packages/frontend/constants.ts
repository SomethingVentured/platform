...
export const NETWORKS: NetworksType = {
  ...
  mainnet: {
    ...
    color: '#ff8b9e',
    chainId: 1,
    rpcUrl: `https://speedy-nodes-nyc.moralis.io/${INFURA_ID}/eth/mainnet`,
  ...
  rinkeby: {
    ...
    color: '#e0d068',
    chainId: 4,
    rpcUrl: `https://speedy-nodes-nyc.moralis.io/${INFURA_ID}/eth/rinkeby`,
  ...
  mumbai: {
    ...
    price: 1,
    gasPrice: 1000000000,
    rpcUrl: `https://speedy-nodes-nyc.moralis.io/${INFURA_ID}/polygon/mumbai`,
    faucet: 'https://faucet.matic.network/',
