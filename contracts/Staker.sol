...
contract Staker {
  ...
  // The goal which should be met
  // This should be retrieved from the frontend
  ...
  uint256 public deadline = block.timestamp + 0.4 minutes;
  ...
  function execute() public {
    ...
    require(block.timestamp>=deadline, "Have not reached deadline yet");
